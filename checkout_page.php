...
.otSecDiv{
	...
	background:#F3F7F8; border-radius:4px; padding-top: 15px;
...
.otSecDiv h4{
    ...
    font-size: 17px;
    font-weight: 600;
    font-family: system-ui; margin-bottom:0px; 
}
.addLayout{
...
.pimgsec{
	float:left; margin-right:10px; width:30%;
}
...
.mdSec h6{
	font-weight:500; margin-bottom:10px;     font-size: 15px;
}
	...
	<div class="container">
		<div class="row">			
			...
			<div class="col-lg-8">
				...
				<div class="row otSecDiv">
				
<div class="col-lg-12">
			<h4 class="topHeadSec">Delivery Address</h4><br>
		</div>
...
<div class="col-lg-12">
			<h4 class="topHeadSec">Make Payment</h4><br>
		</div>

<div class="col-lg-6">
	<div class="addLayout" style="padding-bottom: 35px;">
		<h5>Pay Online</h5><hr>
		<p>Go to Payment Getway</p>
		<a href="" class="payOnl">Pay £53.85</a>
	</div>
</div>
...
<?php for($i=0; $i<=2; $i++){ ?>				
				...
				<div class="itemTotSec">
	<ul>
		<li>Item Total : £217.95</li>
		<li>Delivery Charges : £0 (free)</li>
		<li>Total Discount : £0 </li>
	</ul>
	<hr>
	<ul>
		<li>To Pay : £217.95</li>
